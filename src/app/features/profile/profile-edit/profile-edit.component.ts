                ...
                <div class="px-6 py-4 space-y-6">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      />
                      @if (profileForm.get('first_name')?.errors && profileForm.get('first_name')?.touched) {
                    ...
                    <div>
                      ...
                      <input
                        ...
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                      />
                      @if (profileForm.get('last_name')?.errors && profileForm.get('last_name')?.touched) {
              ...
              <div class="bg-white shadow rounded-lg">
                ...
                <div class="px-6 py-4 space-y-6">
                  ...
                  <div>
                    ...
                    />
                    @if (profileForm.get('website_url')?.errors && profileForm.get('website_url')?.touched) {
              ...
              <div class="bg-white shadow rounded-lg">
                ...
                <div class="px-6 py-4 space-y-6">
                  <div>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                      ...
                      <input
                        type="text"
                        id="github_username"
                        formControlName="github_username"
                  ...
                  <div>
                    ...
                    />
                    @if (profileForm.get('linkedin_url')?.errors && profileForm.get('linkedin_url')?.touched) {
                      <p class="mt-1 text-sm text-red-600">Please enter a valid LinkedIn URL</p>
                    }
                  </div>
                </div>
              </div>
