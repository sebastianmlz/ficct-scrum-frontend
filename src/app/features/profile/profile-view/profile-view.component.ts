                ...
                <div class="flex items-center space-x-6">
                  ...
                  <div class="flex-shrink-0">
                    @if (user()?.avatar_url) {
                      ...
                      <div class="h-24 w-24 bg-gray-300 rounded-full flex items-center justify-center">
                        <span class="text-xl font-medium text-gray-700">{{ getInitials(user()!.full_name) }}</span>
                      </div>
                    }
                  </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div class="lg:col-span-2">
                <div class="bg-white shadow rounded-lg">
                  ...
                  <div class="px-6 py-4">
                    @if (userProfile()?.bio) {
                      <p class="text-gray-700 whitespace-pre-wrap">{{ userProfile()!.bio }}</p>
                    } @else {
                    ...
                    <dl class="space-y-4">
                      ...
                      @if (userProfile()?.phone_number) {
                        <div>
                          ...
                          <dd class="mt-1 text-sm text-gray-900">{{ userProfile()!.phone_number }}</dd>
                        </div>
                      }
                      @if (userProfile()?.website_url) {
                        <div>
                          ...
                          <dd class="mt-1 text-sm text-gray-900">
                            <a [href]="userProfile()!.website_url" target="_blank" class="text-blue-600 hover:text-blue-500">
              ...
              <div class="space-y-6">
                  ...
                  <div class="px-6 py-4">
                    <dl class="space-y-4">
                      <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ user()!.date_joined | date:'fullDate' }}</dd>
                      </div>
                      @if (user()!.last_login) {
                        <div>
                          <dt class="text-sm font-medium text-gray-500">Last Login</dt>
                          <dd class="mt-1 text-sm text-gray-900">{{ user()!.last_login | date:'medium' }}</dd>
                        </div>
                      }
                      <div>
                ...
                <!-- Social Links -->
                @if (userProfile()?.github_username || userProfile()?.linkedin_url) {
                  <div class="bg-white shadow rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200">
                      ...
                      <div class="space-y-3">
                        @if (userProfile()?.github_username) {
                          <a [href]="'https://github.com/' + userProfile()!.github_username" 
                            ...
                            <svg class="h-5 w-5 text-gray-600 mr-3" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ userProfile()!.github_username }}</span>
                          </a>
                        }
                ...
                <!-- Preferences -->
                @if (userProfile()?.timezone || userProfile()?.language) {
                  <div class="bg-white shadow rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200">
                      ...
                      <dl class="space-y-4">
                        @if (userProfile()?.timezone) {
                          <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ userProfile()!.timezone }}</dd>
                          </div>
                        }
                        @if (userProfile()?.language) {
                          <div>
                            <dt class="text-sm font-medium text-gray-500">Language</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ userProfile()!.language }}</dd>
                          </div>
                        }
                      </dl>
                    </div>
